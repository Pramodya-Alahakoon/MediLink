...
function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center overflow-hidden bg-secondary">
      ...
      <div className="container mx-auto px-5 sm:px-8 lg:px-16 xl:px-20 relative z-10 pt-28 pb-16 lg:pt-36 lg:pb-20">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 xl:gap-20">
          ...
          <div className="w-full lg:w-[52%] flex flex-col items-start text-left space-y-7">
            ...
            >
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold font-manrope text-tertiary leading-[1.07] tracking-tight">
                Your Health,
                <br />
            ...
            <motion.p
              ...
              className="text-neutral text-base sm:text-lg leading-relaxed max-w-md font-inter"
            >
            ...
            >
              ...
              <Link to="/about">
                <button className="group flex items-center justify-center gap-2 border-2 border-tertiary/15 bg-white/70 backdrop-blur-sm text-tertiary font-semibold font-inter px-6 py-4 rounded-2xl hover:border-primary/30 hover:text-primary hover:bg-white transition-all duration-300 text-sm sm:text-base w-full sm:w-auto">
            ...
            >
              <div className="flex -space-x-2.5">
                {["/Images/specialist_1.png", "/Images/specialist_2.png", "/Images/specialist_3.png"].map((src, i) => (
                  <img key={i} src={src} alt="Doctor" className="w-9 h-9 rounded-full border-2 border-white object-cover object-top bg-secondary" />
                ))}
              </div>
              <div>
                ...
                <p className="text-xs text-neutral font-inter"><span className="font-semibold text-tertiary">4.9/5</span> from 12,000+ reviews</p>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[2.5rem] overflow-hidden border border-white/60 shadow-2xl h-[420px] sm:h-[500px] lg:h-[560px] bg-gradient-to-br from-primary/5 to-tertiary/5">
                <img
              ...
              <motion.div
                ...
                className="absolute -left-4 sm:-left-8 top-[18%] glass rounded-2xl px-4 py-3.5 shadow-xl flex items-center gap-3 z-20 min-w-[150px]"
              >
                <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0">
                  <FiShield className="w-5 h-5 text-primary" />
                </div>
                <div>
                  <p className="font-extrabold text-tertiary font-manrope text-base leading-none mb-0.5">50K+</p>
                  <p className="text-xs text-neutral font-inter">Happy Patients</p>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute -right-4 sm:-right-8 bottom-[20%] glass rounded-2xl px-4 py-3.5 shadow-xl flex items-center gap-3 z-20 min-w-[150px]"
              >
                ...
                <div>
                  <p className="font-extrabold text-tertiary font-manrope text-base leading-none mb-0.5">500+</p>
                  <p className="text-xs text-neutral font-inter">Expert Doctors</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
