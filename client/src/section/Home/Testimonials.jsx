...
const testimonials = [
  {
    id: 1,
    quote: "I booked a specialist in under two minutes. No hold music, no confusion. MediLink is genuinely the future of healthcare.",
    author: "Sophia Reynolds",
    role: "Primary Care Patient",
    avatar: "https://ui-avatars.com/api/?name=Sophia+R&background=007A7C&color=fff&size=80&bold=true",
    condition: "Managed Hypertension",
  },
  {
    id: 2,
    quote: "The video consult quality was incredible. I genuinely felt like Dr. Chen was in the room with me. This platform is leagues ahead.",
    author: "James Thompson",
    role: "Remote Consultation User",
    avatar: "https://ui-avatars.com/api/?name=James+T&background=102A43&color=fff&size=80&bold=true",
    condition: "Orthopedic Follow-up",
  },
  {
    id: 3,
    quote: "The AI symptom checker sent me to the right doctor immediately. I didn't waste a single day waiting. It saved my peace of mind.",
    author: "Priya Nair",
    role: "New User",
    avatar: "https://ui-avatars.com/api/?name=Priya+N&background=5a2d73&color=fff&size=80&bold=true",
