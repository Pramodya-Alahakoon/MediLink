        ...
        <div className="container mx-auto px-5 sm:px-8 lg:px-16 xl:px-20">
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                <div>
                  <p className="font-bold font-manrope text-tertiary mb-1">Privacy Questions?</p>
                  <p className="text-sm text-neutral font-inter">Contact our Data Protection Officer at <a href="mailto:privacy@medilink.cloud" className="text-primary hover:underline">privacy@medilink.cloud</a></p>
                </div>
                <Link to="/contact">
