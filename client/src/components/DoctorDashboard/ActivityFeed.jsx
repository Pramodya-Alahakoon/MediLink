  ...
  const activities = [
    {
      ...
      title: (
        <span className="text-[#112429] dark:text-slate-200">
          <strong>Sarah Jenkins</strong> uploaded a lab report
        </span>
      ),
      time: "24 MINS AGO",
    },
    {
      ...
      title: (
        <span className="text-[#112429] dark:text-slate-200">
          <strong>Mark Thompson</strong> settled pending invoice
        </span>
      ),
      time: "1 HOUR AGO",
    },
    {
      ...
      title: (
        <span className="text-[#112429] dark:text-slate-200">
          <strong>Pharmacy Alert:</strong> Refill request for Room 302
        </span>
      ),
      time: "2 HOURS AGO",
    },
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm border border-slate-100 dark:border-slate-800 font-inter transition-all duration-300">
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="text-xs font-bold text-[#055153] dark:text-teal-400 hover:underline">
          See All
        </button>
      </div>
