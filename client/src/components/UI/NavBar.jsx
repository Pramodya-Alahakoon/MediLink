...
function NavComponent() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 w-screen">
      ...
      <div
        className={`flex items-center justify-between px-6 md:px-8 lg:px-12 py-[17px] bg-white w-full transition-all duration-300 ${
          isScrolled ? "shadow-lg" : "shadow-sm"
        }`}
        ref={dropDownRef}
      >
        <div className="flex items-center">
          <Logo className="2xl:w-[201px] w-[130px] 2xl:h-[97px] h-[50px]" />
        </div>
