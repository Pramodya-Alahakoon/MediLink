...
export const updateAppointmentSettings = async (req, res, next) => {
  try {
    const { doctorId, appointmentDuration, bufferTime, isBufferTimeEnabled, maxAppointmentsPerDay, defaultStartTime, defaultEndTime, workingDays } = req.body;
    ...
    if (isBufferTimeEnabled !== undefined) updateData.isBufferTimeEnabled = isBufferTimeEnabled;
    if (maxAppointmentsPerDay !== undefined) updateData.maxAppointmentsPerDay = maxAppointmentsPerDay;
    if (defaultStartTime !== undefined) updateData.defaultStartTime = defaultStartTime;
    if (defaultEndTime !== undefined) updateData.defaultEndTime = defaultEndTime;
