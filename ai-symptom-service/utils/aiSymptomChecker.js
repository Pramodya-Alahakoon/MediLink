...
- Always include at least 3 pre-medication steps`;
        ...
        if (jsonMatch) {
            try {
                ...
                return {
                    ...
                    preMedicationSteps: Array.isArray(parsed.preMedicationSteps) ? parsed.preMedicationSteps : [],
        ...
        if (error.message.includes("API_KEY_INVALID")) {
            ...
            console.error("   → Gemini API is experiencing high demand. Using default suggestions.");
        }
...
const getDefaultResponse = () => {
    return {
        suggestion: "Please consult with a licensed physician for proper diagnosis and treatment of your symptoms.",
